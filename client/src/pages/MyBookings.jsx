                ...
                <div key = {booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                    {/* Hotel Details*/}
                        <div className='flex flex-col md:flex-row'>
                            <img onClick={()=>{navigate(`/rooms/${booking.hotel._id}`)}}
                            src= {booking.room.images[0]} 
                            alt = "hotel-image"
                            className='cursor-pointer min-md:w-44 rounded shadow onject-cover' />
                    ...
                    {/* Date & Timings */}
                        <div className='flex flex-row md:items-ceneter md:gap-12 mt-3 gap-8'>
                            <div>
                                <p>Check-In</p>
                    ...
                    {/* Payment */}
                        <div className='flex flex-col items-start justify-center pt-3'>
                            ...
                            {
                                !booking.isPaid && (
                                    <button className='px-4 py-1.5 mt-4 trxt-xs border border-gray-400 rounded-full hover:bg-gray transition-all cursor-pointer'>
                                        Pay Now
                                    </button>
                                )
                            }
